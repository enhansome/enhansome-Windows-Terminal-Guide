...
[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,986 | 🐛 1,771 | 🌐 C++ | 📅 2026-09-24 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more. Take a look at the [Windows Terminal GitHub](https://github.com/Microsoft/Terminal) ⭐ 104,986 | 🐛 1,771 | 🌐 C++ | 📅 2026-09-24.
...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,264 | 🐛 323 | 🌐 TypeScript | 📅 2026-09-24 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,299 | 🐛 7,971 | 🌐 C# | 📅 2026-09-25 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,318 | 🐛 4,034 | 🌐 C# | 📅 2026-09-25 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,797 | 🐛 23 | 🌐 TypeSpec | 📅 2026-09-24 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,234 | 🐛 79 | 🌐 Markdown | 📅 2026-09-24 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,449 | 🐛 757 | 🌐 C# | 📅 2026-09-24 is a cross-platform gaming framework based on Microsoft's XNA framework that's extremely easy to learn. Best of all, games you build with MonoGame will run on iOS, Android, Mac OS X, tvOS, Windows, Linux, PlayStation 4, and more—write once, play anywhere.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,441 | 🐛 701 | 🌐 TypeScript | 📅 2026-09-24 is a repository for high quality TypeScript type definitions.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,700 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-09-25 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,579 | 🐛 337 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,646 | 🐛 411 | 🌐 Go | 📅 2026-09-25 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
