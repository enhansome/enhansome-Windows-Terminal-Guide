...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,248 | 🐛 377 | 🌐 TypeScript | 📅 2026-08-21 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,782 | 🐛 70 | 🌐 Go | 📅 2026-08-21 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,223 | 🐛 7,574 | 🌐 C# | 📅 2026-08-21 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,310 | 🐛 3,734 | 🌐 C# | 📅 2026-08-21 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,381 | 🐛 675 | 🌐 TypeScript | 📅 2026-08-21 is a repository for high quality TypeScript type definitions.
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,604 | 🐛 559 | 🌐 WebAssembly | 📅 2026-08-21.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,641 | 🐛 1,500 | 🌐 TypeScript | 📅 2026-08-21 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,441 | 🐛 332 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,256 | 🐛 396 | 🌐 Go | 📅 2026-08-21 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
