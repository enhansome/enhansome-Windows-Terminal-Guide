...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,250 | 🐛 377 | 🌐 TypeScript | 📅 2026-08-21 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,224 | 🐛 7,583 | 🌐 C# | 📅 2026-08-23 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,310 | 🐛 3,742 | 🌐 C# | 📅 2026-08-23 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,334 | 🐛 757 | 🌐 C# | 📅 2026-08-23 is a cross-platform gaming framework based on Microsoft's XNA framework that's extremely easy to learn. Best of all, games you build with MonoGame will run on iOS, Android, Mac OS X, tvOS, Windows, Linux, PlayStation 4, and more—write once, play anywhere.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,388 | 🐛 681 | 🌐 TypeScript | 📅 2026-08-23 is a repository for high quality TypeScript type definitions.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,267 | 🐛 394 | 🌐 Go | 📅 2026-08-23 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
