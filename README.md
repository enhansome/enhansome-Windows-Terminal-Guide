...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,256 | 🐛 360 | 🌐 TypeScript | 📅 2026-09-07 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,255 | 🐛 7,728 | 🌐 C# | 📅 2026-09-07 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,027 | 🐛 170 | 🌐 C# | 📅 2026-09-07 is the open-source .NET assembly browser and decompiler.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 24 | 🌐 TypeSpec | 📅 2026-08-31 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,206 | 🐛 79 | 🌐 Markdown | 📅 2026-09-01 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,431 | 🐛 692 | 🌐 TypeScript | 📅 2026-09-07 is a repository for high quality TypeScript type definitions.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,462 | 🐛 402 | 🌐 Go | 📅 2026-09-08 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
