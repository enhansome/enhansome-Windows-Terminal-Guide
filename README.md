...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,549 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,257 | 🐛 365 | 🌐 TypeScript | 📅 2026-09-04 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,715 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,715 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,715 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,715 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,715 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,895 | 🐛 76 | 🌐 Go | 📅 2026-09-04 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,252 | 🐛 7,704 | 🌐 C# | 📅 2026-09-06 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,019 | 🐛 170 | 🌐 C# | 📅 2026-09-06 is the open-source .NET assembly browser and decompiler.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,428 | 🐛 688 | 🌐 TypeScript | 📅 2026-09-05 is a repository for high quality TypeScript type definitions.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,486 | 🐛 337 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,446 | 🐛 402 | 🌐 Go | 📅 2026-09-06 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
