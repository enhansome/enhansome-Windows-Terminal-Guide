...
1. [Getting Started with Windows Terminal](https://github.com/mikeroyal/Windows-Terminal-Guide#getting-started-with-windows-terminal) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

2. [VSCode Development](https://github.com/mikeroyal/Windows-Terminal-Guide#vscode-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

   * [VS Code Extensions for Developer Productivity](https://github.com/mikeroyal/Windows-Terminal-Guide#VS-Code-Extensions-for-Developer-Productivity) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

3. [Windows Subsystem for Linux (WSL)](https://github.com/mikeroyal/Windows-Terminal-Guide#windows-subsystem-for-linux-wsl) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

4. [Azure Development](https://github.com/mikeroyal/Windows-Terminal-Guide#azure-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

5. [AWS Development](https://github.com/mikeroyal/Windows-Terminal-Guide#aws-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

6. [Google Cloud Development](https://github.com/mikeroyal/Windows-Terminal-Guide#google-cloud-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

7. [Kubernetes](https://github.com/mikeroyal/Windows-Terminal-Guide#kubernetes) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

8. [Docker](https://github.com/mikeroyal/Windows-Terminal-Guide#docker) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

9. [PowerShell Development](https://github.com/mikeroyal/Windows-Terminal-Guide#powershell-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

10. [.NET Development](https://github.com/mikeroyal/Windows-Terminal-Guide#net-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

11. [C# Development](https://github.com/mikeroyal/Windows-Terminal-Guide#c-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

12. [F# Development](https://github.com/mikeroyal/Windows-Terminal-Guide#f-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

13. [Xamarin Development](https://github.com/mikeroyal/Windows-Terminal-Guide#Xaramin-Development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

14. [TypeScript Development](https://github.com/mikeroyal/Windows-Terminal-Guide#typescript-development) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

15. [Networking](https://github.com/mikeroyal/Windows-Terminal-Guide#networking) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

16. [Databases](https://github.com/mikeroyal/Windows-Terminal-Guide#databases) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

# Awesome Getting Started with Windows Terminal with stars

[Back to the Top](https://github.com/mikeroyal/Windows-Terminal-Guide#table-of-contents) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04

[Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,597 | 🐛 1,735 | 🌐 C++ | 📅 2026-08-13 is a new, modern, feature-rich, productive terminal application for command-line users. It includes many of the features most frequently requested by the Windows command-line community including support for tabs, rich text, globalization, configurability, theming & styling, and more. Take a look at the [Windows Terminal GitHub](https://github.com/Microsoft/Terminal) ⭐ 104,597 | 🐛 1,735 | 🌐 C++ | 📅 2026-08-13.
...
[AWS Serverless Application Model (SAM) CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,727 | 🐛 531 | 🌐 Python | 📅 2026-08-13 is a command line tool for an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 63 | 🌐 Shell | 📅 2026-08-13 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,680 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,680 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,680 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,680 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,680 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,732 | 🐛 74 | 🌐 Go | 📅 2026-08-12 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,210 | 🐛 7,664 | 🌐 C# | 📅 2026-08-13 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,855 | 🐛 191 | 🌐 C# | 📅 2026-08-13 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,300 | 🐛 3,803 | 🌐 C# | 📅 2026-08-13 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Back to the Top](https://github.com/mikeroyal/Xaramin-Guide#table-of-contents) ⭐ 9 | 🐛 0 | 🌐 C# | 📅 2022-01-03
...
[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,301 | 🐛 755 | 🌐 C# | 📅 2026-08-13 is a cross-platform gaming framework based on Microsoft's XNA framework that's extremely easy to learn. Best of all, games you build with MonoGame will run on iOS, Android, Mac OS X, tvOS, Windows, Linux, PlayStation 4, and more—write once, play anywhere.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,371 | 🐛 685 | 🌐 TypeScript | 📅 2026-08-13 is a repository for high quality TypeScript type definitions.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,631 | 🐛 1,512 | 🌐 TypeScript | 📅 2026-08-13 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[TS node](https://github.com/TypeStrong/ts-node) ⭐ 13,132 | 🐛 232 | 🌐 TypeScript | 📅 2024-07-18 is a TypeScript execution and REPL for node.js.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,181 | 🐛 384 | 🌐 Go | 📅 2026-08-13 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Windows-Terminal-Guide/pulls) ⭐ 111 | 🐛 1 | 🌐 PowerShell | 📅 2024-01-04.
