...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,535 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,692 | 🐛 204 | 🌐 Jinja | 📅 2026-08-17, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,692 | 🐛 204 | 🌐 Jinja | 📅 2026-08-17, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,692 | 🐛 204 | 🌐 Jinja | 📅 2026-08-17, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,692 | 🐛 204 | 🌐 Jinja | 📅 2026-08-17, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,692 | 🐛 204 | 🌐 Jinja | 📅 2026-08-17 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,770 | 🐛 77 | 🌐 Go | 📅 2026-08-20 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,221 | 🐛 7,580 | 🌐 C# | 📅 2026-08-20 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,902 | 🐛 189 | 🌐 C# | 📅 2026-08-20 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,310 | 🐛 3,712 | 🌐 C# | 📅 2026-08-20 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,328 | 🐛 754 | 🌐 C# | 📅 2026-08-20 is a cross-platform gaming framework based on Microsoft's XNA framework that's extremely easy to learn. Best of all, games you build with MonoGame will run on iOS, Android, Mac OS X, tvOS, Windows, Linux, PlayStation 4, and more—write once, play anywhere.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,381 | 🐛 679 | 🌐 TypeScript | 📅 2026-08-20 is a repository for high quality TypeScript type definitions.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,636 | 🐛 1,499 | 🌐 TypeScript | 📅 2026-08-20 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,244 | 🐛 393 | 🌐 Go | 📅 2026-08-20 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
