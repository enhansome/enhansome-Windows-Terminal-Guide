...
[WSL 2 Linux Kernel on GitHub](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,557 | 🐛 134 | 🌐 C | 📅 2026-08-01 is the source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2).
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,279 | 🐛 7,895 | 🌐 C# | 📅 2026-09-18 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,090 | 🐛 174 | 🌐 C# | 📅 2026-09-17 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,313 | 🐛 3,948 | 🌐 C# | 📅 2026-09-17 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,439 | 🐛 696 | 🌐 TypeScript | 📅 2026-09-16 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,651 | 🐛 651 | 🌐 TypeScript | 📅 2026-09-11 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,692 | 🐛 1,511 | 🌐 TypeScript | 📅 2026-09-18 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Wuzz](https://github.com/asciimoo/wuzz) ⭐ 10,734 | 🐛 41 | 🌐 Go | 📅 2026-08-04 is an interactive cli tool for HTTP inspection. It can be used to inspect/modify requests copied from the browser's network inspector with the "copy as cURL" feature.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,562 | 🐛 405 | 🌐 Go | 📅 2026-09-18 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
