...
[K3s](https://github.com/rancher/k3s) ⭐ 33,957 | 🐛 84 | 🌐 Go | 📅 2026-09-14 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,274 | 🐛 7,846 | 🌐 C# | 📅 2026-09-15 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,066 | 🐛 178 | 🌐 C# | 📅 2026-09-14 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,320 | 🐛 3,903 | 🌐 C# | 📅 2026-09-14 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,418 | 🐛 771 | 🌐 C# | 📅 2026-09-14 is a cross-platform gaming framework based on Microsoft's XNA framework that's extremely easy to learn. Best of all, games you build with MonoGame will run on iOS, Android, Mac OS X, tvOS, Windows, Linux, PlayStation 4, and more—write once, play anywhere.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,437 | 🐛 694 | 🌐 TypeScript | 📅 2026-09-14 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,653 | 🐛 645 | 🌐 TypeScript | 📅 2026-09-11 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,690 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-09-15 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,522 | 🐛 398 | 🌐 Go | 📅 2026-09-15 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
