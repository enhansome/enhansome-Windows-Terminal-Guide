...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,740 | 🐛 201 | 🌐 Jinja | 📅 2026-09-18, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,740 | 🐛 201 | 🌐 Jinja | 📅 2026-09-18, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,740 | 🐛 201 | 🌐 Jinja | 📅 2026-09-18, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,740 | 🐛 201 | 🌐 Jinja | 📅 2026-09-18, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,740 | 🐛 201 | 🌐 Jinja | 📅 2026-09-18 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,992 | 🐛 112 | 🌐 Go | 📅 2026-09-18 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,285 | 🐛 7,925 | 🌐 C# | 📅 2026-09-18 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,314 | 🐛 3,949 | 🌐 C# | 📅 2026-09-18 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,437 | 🐛 699 | 🌐 TypeScript | 📅 2026-09-18 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,653 | 🐛 660 | 🌐 TypeScript | 📅 2026-09-18 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[Netdata](https://github.com/netdata/netdata) ⭐ 80,575 | 🐛 405 | 🌐 Go | 📅 2026-09-19 is high-fidelity infrastructure monitoring and troubleshooting, real-time monitoring Agent collects thousands of metrics from systems, hardware, containers, and applications with zero configuration. It runs permanently on all your physical/virtual servers, containers, cloud deployments, and edge/IoT devices, and is perfectly safe to install on your systems mid-incident without any preparation.
